...
もちろんPDGにはFile Compress Topがあり、それを使ってZipファイルを作ることができますが、個人的にはコピーされたものを確認してから、圧縮するのが良いと思っているので、ここまでにしておきます。
...
個人的な見解として、日本のように1つのプロジェクトで多数のベンダー会社とデータを共有する必要がある場合、USDの採用が非常に有効だと考えています。本記事を通じて、データ共有の容易さを感じていただき、より多くの企業がUSDへの移行を検討していただけることを願っています。そして今後仕事を振る側の会社はUSDベースになってもらい、USD使えない下請け会社には仕事を振られる機会が減っていくような流れがおきても良いと思っています。